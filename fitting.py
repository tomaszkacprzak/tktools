...
def fit_positive(x,y,s="none",expand=linearBasis,empirical_errors=False,unit_box=False,invert_x=False,eps=1e-40):
...
def predict_positive(x,w,expand=linearBasis):
